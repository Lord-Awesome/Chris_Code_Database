def startShow(show_dict):
    ...
    if showName == "Reversi":
        ...
        #train determines whether the computer trains. If no, plays number_of_games. If yes, trains for number of games specified in train_iterations then plays number_of_games
        ...
        #sleep_time is the time in seconds between each move
        # R_value_white etc. indicate the RGB color codes for the lights corresponding to each player
        ...
        try: train_iterations = show_dict['train_iterations']
        ...
        try: number_of_games = show_dict['number_of_games']
        except: print("Warning: could not get number_of_games")
        try: sleep_time = show_dict['sleep_time']
        except: print("Warning: could not get sleep_time")
        try: R_value_black = show_dict['R_value_black']
        except: print("Warning: could not get R_value_black")
        try: G_value_black = show_dict['G_value_black']
        except: print("Warning: could not get G_value_black")
        try: B_value_black = show_dict['B_value_black']
        except: print("Warning: could not get B_value_black")
        try: R_value_white = show_dict['R_value_white']
        except: print("Warning: could not get R_value_white")
        try: G_value_white = show_dict['G_value_white']
    ...
    if showName == "Tic_tac_toe":
        ...
        try: display_on_lights_train_boolean = show_dict['display_on_lights_train_boolean']
        except: print("Warning: could not get display_on_lights_train_boolean")
