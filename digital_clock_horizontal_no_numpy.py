...
def digital_clock_horizontal_no_numpy(timer_value = 1, timer_unit = "minutes", display_on_lights_bool = 0, divisor=16):
    ...
    #RBG
    hour_color = RGB_to_color(50,255,50,divisor) #blue
    minute_color = RGB_to_color(255,0,50,divisor) #red
    second_color = RGB_to_color(200,50,200,divisor) #yellow
    ...
    [new_grid, hour, minute, second] = print_big_clock(empty_grid, display_on_lights_bool)
    ...
    while 1:
        ...
        [new_grid, hour, minute, second] = print_big_clock(empty_grid, display_on_lights_bool) #Get the clock board state so we can check if it's changed
...
def print_timer(grid, seconds_remaining, timer_unit, display_on_lights_bool, timer_color, divisor):
    ...
    for index in digit_list[0]: #digit 7  (timer)
        ...
        grid[i_j_to_index(index[0], index[1])] = 4
        if display_on_lights_bool == 1:
...
def print_big_clock(grid, display_on_lights_bool):
    ...
    for index in digit_list[0]: #digit one
        ...
        grid[i_j_to_index(index[0], index[1])] = 1
        if display_on_lights_bool == 1:
    ...
    for index in digit_list[2]: #digit three
        ...
        grid[i_j_to_index(index[0], index[1])] = 2
        if display_on_lights_bool == 1:
    ...
    for index in digit_list[4]: #digit 5 (seconds)
        ...
        grid[i_j_to_index(index[0], index[1])] = 3
        if display_on_lights_bool == 1:
